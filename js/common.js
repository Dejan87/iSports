...
$(".carousel-wrap-about-sections").owlCarousel({
	...
	/*magnific-popup-belgrade*/
		$('.mfp-gallery-belgrade').magnificPopup({
	...
	/*magnific-popup-athens*/
	$('.mfp-gallery-athens').magnificPopup({
		mainClass: 'mfp-zoom-in',
		type: 'image',
		tLoading: '',
		gallery:{
	...
	/*magnific-popup-malta*/
	$('.mfp-gallery-malta').magnificPopup({
		mainClass: 'mfp-zoom-in',
		type: 'image',
		tLoading: '',
		gallery:{
	...
	/*magnific-popup-istanbul*/
	$('.mfp-gallery-istanbul').magnificPopup({
		mainClass: 'mfp-zoom-in',
		type: 'image',
		tLoading: '',
		gallery:{
	...
	/*magnific-popup-medulin*/
	$('.mfp-gallery-medulin').magnificPopup({
		mainClass: 'mfp-zoom-in',
		type: 'image',
		tLoading: '',
		gallery:{
	...
	/*magnific-popup-antalija*/
	$('.mfp-gallery-antalija').magnificPopup({
		mainClass: 'mfp-zoom-in',
		type: 'image',
		tLoading: '',
		gallery:{
	...
	/*magnific-popup-spain*/
	$('.mfp-gallery-spain').magnificPopup({
		mainClass: 'mfp-zoom-in',
		type: 'image',
		tLoading: '',
		gallery:{
